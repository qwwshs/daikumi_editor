...
objact_music_play = { --分度改变用的
    load = function(x1,y1,r1,w1,h1)
        ...
        h = h1
        r = r1
        button_new("music_play",will_do,x,y,w,h,ui_pause,{will_draw = will_draw_play}) --ui反着写因为play与pause是相反显示的
        button_new("music_pause",will_do,x,y,w,h,ui_play,{will_draw = will_draw_pause})
    end,
    draw = function()
    end,
