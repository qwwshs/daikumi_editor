...
local function draw_this_button()
    ui_style:button(x,y,w,h,objact_language.get_string_in_languages("delete music"))
end
...
local function will_do()
    ...
    objact_message_box.message_window_dlsplay("delete music?",yes_func,function() end)
end
...
load = function(x1,y1,r1,w1,h1)
    ...
    h = h1
    r = r1
    button_new("delete_music",will_do,x,y,w,h,draw_this_button,{will_draw = will_draw})
end,
draw = function()
end,
